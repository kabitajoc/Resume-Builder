...
const Contact = ({ aboutData }) => {
  ...
  return (
    <>
      <div className="flex">
        <aside className=" bg-slate-700 text-white p-4 shadow-md py-7 pr-6 pl-14 max-w min-h">
          <img
          ...
          <div className="output-row mt-4">
            <div className="output-field flex ">
              <span className=" border w-6 h-6 rounded-full bg-white flex items-center justify-center mr-3">
                <svg
          ...
          <div className="output-row mt-4">
            <div className="output-field flex flex-wrap">
              <span className=" border w-6 h-6 rounded-full bg-white flex items-center justify-center mr-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
